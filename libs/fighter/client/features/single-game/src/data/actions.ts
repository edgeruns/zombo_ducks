...
export const waitNextRound = createAsyncThunk<
    ...
    void,
    { state: FeatureState }
>('singleGame/waitNextRound', async (_, { dispatch, getState }) => {
    const state = getState()
    const game = Game.init(state.singleGame.game)
...
export const sendAction = createAsyncThunk<
    ...
    void,
    { state: FeatureState }
>('singleGame/sendAction', async (_, { getState }) => {
    const state = getState()
...
export const finishRound = createAsyncThunk<
    ...
    FinishRoundArgs,
    { state: FeatureState }
>('singleGame/finishRound', async (args, { getState }) => {
    const state = getState()
...
export const selectAttack = createAction<SelectAttackPayload>(
    'singleGame/selectAttack'
)
export const selectDefence = createAction<SelectDefencePayload>(
    'singleGame/selectDefence'
)
...
export const quit = createAsyncThunk<void, void>(
    'singleGame/quit',
    async () => {
        console.log('Quit')
    }
