...
import { AppDispatch, Mode, BodyParts, slice, selectors } from '@apps/bar/data'
import { BodyPart, CrossButton } from '@apps/bar/uikit'
            ...
            <div className={styles.screens}>
                <div className={bodyPartsScreenClassName}>
                    <span className={styles.text}>
                        You can attack one of your opponent's<br/>
                ...
                <div className={roundsScreenClassName}>
                    <span className={styles.text}>
                        The fighting consists of 5 rounds<br />
                        10 seconds each.<br />
                        You can make three moves in each round.<br />
                    </span>
                </div>
            </div>
