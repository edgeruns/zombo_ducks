...
import { selectors, slice } from '@apps/games-zombofighter-client-data'
...
export const Tutorial: FC = () => {
    ...
    return (
        <div className={rootClassName}>
            ...
            <div className={hintClassName} onClick={handleHintClick}>
                <div className={styles['hint__text']}>{STEPS[activeIndex]}</div>
